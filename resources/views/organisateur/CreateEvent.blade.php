    ...
    <div class="container mx-auto p-8 bg-white rounded shadow mt-6 ">
        ...
        <form action="{{ route('Event.store') }}" method="post" enctype="multipart/form-data" class="max-w-md mx-auto">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="titre" value="{{ old('titre') }}" id="titre" class="form-input w-full" >
            </div>

            <div class="mb-4">
                <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Description:</label>
                <textarea name="description"  id="description" class="form-textarea w-full" >{{ old('description') }}</textarea>
            </div>

            <div class="mb-4">
                <label for="lieu" class="block text-gray-700 text-sm font-bold mb-2">Lieu:</label>
                <input type="text" name="lieu" value="{{ old('lieu') }}" id="lieu" class="form-input w-full" >
            </div>

            <div class="mb-4">
                <label for="date" class="block text-gray-700 text-sm font-bold mb-2">Date:</label>
                <input type="date" name="date" value="{{ old('date') }}" id="date" class="form-input w-full" >
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="status"  value="{{ old('status') }}" id="status" class="form-select w-full" >
